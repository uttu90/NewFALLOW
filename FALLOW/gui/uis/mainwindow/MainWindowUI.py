...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.project_check = QtWidgets.QCheckBox(self.centralwidget)
        self.project_check.setObjectName("project_check")
        self.horizontalLayout.addWidget(self.project_check)
        self.data_check = QtWidgets.QCheckBox(self.centralwidget)
        self.data_check.setObjectName("data_check")
        self.horizontalLayout.addWidget(self.data_check)
        self.map_check = QtWidgets.QCheckBox(self.centralwidget)
        self.map_check.setObjectName("map_check")
        self.horizontalLayout.addWidget(self.map_check)
        self.simulation_progress = QtWidgets.QProgressBar(self.centralwidget)
        self.simulation_progress.setProperty("value", 24)
        self.simulation_progress.setObjectName("simulation_progress")
        self.horizontalLayout.addWidget(self.simulation_progress)
        ...
        self.set_map_colors = QtWidgets.QAction(MainWindow)
        self.set_map_colors.setObjectName("set_map_colors")
        self.set_time_simulation = QtWidgets.QAction(MainWindow)
        self.set_time_simulation.setObjectName("set_time_simulation")
        ...
        self.menuSettings.addAction(self.set_time_simulation)
        self.menuSettings.addAction(self.set_map_colors)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.project_check.setText(_translate("MainWindow", "Project"))
        self.data_check.setText(_translate("MainWindow", "Data file"))
        self.map_check.setText(_translate("MainWindow", "Map files"))
        ...
        self.set_map_colors.setText(_translate("MainWindow", "Map colors"))
        self.set_time_simulation.setText(_translate("MainWindow", "Time simulation"))
